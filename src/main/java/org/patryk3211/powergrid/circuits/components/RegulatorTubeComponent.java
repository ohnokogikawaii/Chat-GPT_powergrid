...
public class RegulatorTubeComponent extends OrientableComponent implements IRenderedComponent {
    public static final FloatProperty HOLDING_VOLTAGE = new FloatProperty(PowerGrid.MOD_ID, "regulator_tube_vh", 60, 30, 5000);
    ...
    protected void addProperties(ImmutableCollection.Builder<ComponentProperty<?>> properties) {
        ...
        properties.add(HOLDING_VOLTAGE, BREAKDOWN_VOLTAGE, HOLDING_CURRENT, LIT, power(1500f));
    }
