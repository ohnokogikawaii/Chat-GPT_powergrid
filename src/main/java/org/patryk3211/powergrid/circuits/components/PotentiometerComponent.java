...
public class PotentiometerComponent extends OrientableComponent implements IInteractableComponent, IRenderedComponent, IGoggleLabel {
    public static final FloatProperty RESISTANCE = new FloatProperty(PowerGrid.MOD_ID, "potentiometer_resistance", 1000, 100, 1000000);
    public static final IntProperty VALUE = new IntProperty(PowerGrid.MOD_ID, "potentiometer_value", 50, 0, 1000);
    ...
    protected void addProperties(ImmutableCollection.Builder<ComponentProperty<?>> properties) {
        ...
        properties.add(RESISTANCE, VALUE, LABEL, power(2500));
    }
