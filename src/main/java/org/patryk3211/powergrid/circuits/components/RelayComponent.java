...
public class RelayComponent extends MirrorableComponent {
    public static final FloatProperty THRESHOLD_VOLTAGE = new FloatProperty(PowerGrid.MOD_ID, "relay_threshold", 12, 1, 1200);
    ...
    protected void addProperties(ImmutableCollection.Builder<ComponentProperty<?>> properties) {
        ...
        properties.add(THRESHOLD_VOLTAGE, STATE, THRESHOLD_CURRENT, POLARIZED, current(64));
    }
    ...
    public void bake(@NotNull PlacedComponent placed, @NotNull ComponentCircuitBuilder builder, ThermalBuilder.@NotNull IEmitter thermals) {
        ...
        thermals.builder()
                .setMaxCurrent(64, switchResistance, 125f)
