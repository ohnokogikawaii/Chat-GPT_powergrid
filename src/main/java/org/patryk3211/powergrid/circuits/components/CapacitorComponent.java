...
public class CapacitorComponent extends OrientableComponent {
    public static final FloatProperty CAPACITANCE = new FloatProperty(PowerGrid.MOD_ID, "capacitor_value", 0.1f, 1e-9f, 1000000.0f);
    ...
    public void bake(@NotNull PlacedComponent placed, @NotNull ComponentCircuitBuilder builder, ThermalBuilder.@NotNull IEmitter thermals) {
        var capacitorWire = new CRSeriesWire(placed.get(CAPACITANCE) / 1000000, 0.01f, builder.terminalNode(0), builder.terminalNode(1));
