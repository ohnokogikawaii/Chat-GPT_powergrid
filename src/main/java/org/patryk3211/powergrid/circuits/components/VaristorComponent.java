...
public class VaristorComponent extends OrientableComponent {
    public static final FloatProperty THRESHOLD_VOLTAGE = new FloatProperty(PowerGrid.MOD_ID, "varistor_voltage", 100f, 50f, 10000f);
    ...
    protected void addProperties(ImmutableCollection.Builder<ComponentProperty<?>> properties) {
        ...
        properties.add(THRESHOLD_VOLTAGE, power(1000));
    }
