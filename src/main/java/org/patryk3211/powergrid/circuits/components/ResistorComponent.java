...
public class ResistorComponent extends VerticallyOrientableComponent {
    public static final FloatProperty RESISTANCE = new FloatProperty(PowerGrid.MOD_ID, "resistor_value", 100f, 0.01f, 100_000_000f);
    ...
    protected void addProperties(ImmutableCollection.Builder<ComponentProperty<?>> properties) {
        ...
        properties.add(RESISTANCE, power(5000));
    }
