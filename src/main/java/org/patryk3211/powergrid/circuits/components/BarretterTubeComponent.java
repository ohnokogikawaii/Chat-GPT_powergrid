...
public class BarretterTubeComponent extends OrientableComponent implements IRenderedComponent {
    ...
    public static final FloatProperty HOLDING_CURRENT = new FloatProperty(PowerGrid.MOD_ID, "barretter_current", 0.1f, 0.01f, 20);
    ...
    protected void addProperties(ImmutableCollection.Builder<ComponentProperty<?>> properties) {
        ...
        properties.add(HOLDING_CURRENT, MINIMUM_RESISTANCE, power(500));
    }
    ...
    public void bake(@NotNull PlacedComponent placed, @NotNull ComponentCircuitBuilder builder, @NotNull ThermalBuilder.IEmitter thermals) {
        ...
        final var dissipationFactor = ThermalBehaviour.dissipationFactor(500, operatingTemperature);
        thermals.builder()
                .addHeatSource(tube)
