...
public class VFETComponent extends MirrorableComponent {
    public static final FloatProperty GAIN = new FloatProperty(PowerGrid.MOD_ID, "vfet_gain", 10, 1, 1000);
    public static final FloatProperty K_G = new FloatProperty(PowerGrid.MOD_ID, "vfet_kg", 250, 10, 5000);
    ...
    protected void addProperties(ImmutableCollection.Builder<ComponentProperty<?>> properties) {
        ...
        properties.add(GAIN, K_G, SATURATION_CURRENT, power(1000), voltage(60));
    }
