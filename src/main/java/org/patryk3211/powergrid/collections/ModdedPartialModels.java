...
public class ModdedPartialModels {
    ...
    public static SpriteShiftEntry PAPER_SHIFT;
    public static CTSpriteShiftEntry CONDUCTIVE_CASING;
    public static void initSpriteShifts() {
        PAPER_SHIFT = SpriteShifter.get(
                PowerGrid.asResource("block/plotter_paper"),
                PowerGrid.asResource("block/plotter_paper_shift"));

        CONDUCTIVE_CASING = CTSpriteShifter.getCT(
