...
//import org.patryk3211.powergrid.electricity.battery.lifepo4.charger.LiFePO4ChargerBlock;
...
import org.patryk3211.powergrid.electricity.converter.CommercialPowerConditionerBlock;
import org.patryk3211.powergrid.electricity.converter.StabilizedPowerSupplyBlock;
import org.patryk3211.powergrid.electricity.converter.general.GeneralPowerConditionerBlock;
...
//import org.patryk3211.powergrid.kinetics.generator.speedcontroller.GridSpeedControllerBlock;
...
import org.patryk3211.powergrid.utility.chunkloader.ChunkLoaderBlock;
...
public class ModdedBlocks {
    ...
    public static final BlockEntry<LiFePO4BatteryBlock> LIFEPO4 =
            REGISTRATE.block(
                            "lifepo4",
                            LiFePO4BatteryBlock::new
                    )
                    .blockstate(
                            cubeColumn(
                                    "block/battery/lifepo4_side",
                                    "block/battery/lifepo4_top"
                            )
                    )
                    .initialProperties(
                            SharedProperties::softMetal
                    )
                    .transform(
                            pickaxeOnly()
                    )
    ...
    public static final BlockEntry<CommercialPowerConditionerBlock>
            COMMERCIAL_POWER_CONDITIONER =
            REGISTRATE
                    .block(
                            "commercial_power_conditioner",
                            CommercialPowerConditionerBlock::new
                    )
                    .initialProperties(
                            SharedProperties::softMetal
                    )
                    .blockstate(
                            simple("block/commercial_power_conditioner")
                    )
                    .item()
                    .model(
                            itemWithParent(
                                    "block/commercial_power_conditioner"
                            )
                    )
                    .build()
                    .register();
    ...
    public static final BlockEntry<CommercialPowerConditionerBlock>
            ...
            REGISTRATE
                    ...
                    .blockstate(
                            simple("block/general_power_conditioner")
                    )
                    .item()
                    .model(
                            itemWithParent(
                                    "block/general_power_conditioner"
                            )
                    )
                    .build()
                    .register();

    /*public static final BlockEntry<LiFePO4ChargerBlock> LIFEPO4_CHARGER =
            REGISTRATE
                    .block(
                            "lifepo4_charger",
                            LiFePO4ChargerBlock::new
                    )
                    .blockstate(
                            cubeColumn(
                                    "block/battery/charger/lifepo4_side",
                                    "block/battery/charger/lifepo4_top"
                            )
                    )
                    .initialProperties(
                            SharedProperties::softMetal
    ...
    /*public static final BlockEntry<GridSpeedControllerBlock>
            GRID_SPEED_CONTROLLER =
            PowerGrid.REGISTRATE
                    .block(
                            "grid_speed_controller",
                            GridSpeedControllerBlock::new
                    )
                    .blockstate(
                            org.patryk3211.powergrid.utility
                                    .DataProviderUtility
                                    .horizontalAxisBlock(
                                            "block/grid_speed_controller"
                                    )
                    )
                    .initialProperties(
    ...
    public static final BlockEntry<ChunkLoaderBlock> CHUNK_LOADER =
            REGISTRATE.block(
                    ...
                    .blockstate(
                            surfaceBlock("block/chunk_loader")
                    )
                    .item()
                    .model(
                            itemWithParent("block/chunk_loader")
                    )
                    .build()
                    .register();

    public static final BlockEntry<SolarBlock> SOLAR =
            REGISTRATE.block(
                            "solar",
                            SolarBlock::new
                    )
                    ...
                    .blockstate(
                            surfaceBlock("block/solar")
                    )
                    .item()
                    .model(
                            itemWithParent("block/solar")
                    )
                    .build()
                    .register();

    public static final BlockEntry<StabilizedPowerSupplyBlock>
            STABILIZED_POWER_SUPPLY =
            REGISTRATE
                    .block(
                            "stabilized_power_supply",
                            StabilizedPowerSupplyBlock::new
                    )
                    .initialProperties(
                            SharedProperties::softMetal
                    )
                    .blockstate(
                            simple("block/stabilized_power_supply")
                    )
                    .item()
                    .model(
                            itemWithParent(
                                    "block/stabilized_power_supply"
                            )
                    )
                    .build()
                    .register();
    ...
    public static final BlockEntry<CasingBlock> CONDUCTIVE_CASING = REGISTRATE.block("conductive_casing", CasingBlock::new)
            ...
            .initialProperties(SharedProperties::softMetal)
            .transform(pickaxeOnly())
            .onRegister(connectedTextures(() -> new EncasedCTBehaviour((CTSpriteShiftEntry) ModdedPartialModels.CONDUCTIVE_CASING)))
            .onRegister(casingConnectivity((block, cc) -> cc.makeCasing((Block) block, (CTSpriteShiftEntry) ModdedPartialModels.CONDUCTIVE_CASING)))
            .simpleItem()
            .register();
...
//            .register();
    ...
    public static final BlockEntry<ResistorBlock> RESISTOR = REGISTRATE.block("power_resistor", ResistorBlock::new)
            ...
            .initialProperties(SharedProperties::stone)
            .transform(pickaxeOnly())
            .transform(CThermal.maxPower(2000, 2.0f))
            .item()
