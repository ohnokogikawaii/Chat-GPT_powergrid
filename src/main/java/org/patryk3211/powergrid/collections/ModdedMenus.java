...
import org.patryk3211.powergrid.electricity.converter.CommercialPowerConditionerScreen;
import org.patryk3211.powergrid.electricity.converter.StabilizedPowerSupplyMenu;
import org.patryk3211.powergrid.electricity.converter.StabilizedPowerSupplyScreen;
...
public class ModdedMenus {
    ...
    public static final MenuEntry<StabilizedPowerSupplyMenu>
            STABILIZED_POWER_SUPPLY =
            register(
                    "stabilized_power_supply",
                    StabilizedPowerSupplyMenu::new,
                    () -> StabilizedPowerSupplyScreen::new
            );

    public static final MenuEntry<CommercialPowerConditionerMenu>
            COMMERCIAL_POWER_CONDITIONER =
            register(
                    "commercial_power_conditioner",
                    CommercialPowerConditionerMenu::new,
                    () -> CommercialPowerConditionerScreen::new
            );
