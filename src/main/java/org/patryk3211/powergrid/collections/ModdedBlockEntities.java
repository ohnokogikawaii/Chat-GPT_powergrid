...
//import org.patryk3211.powergrid.electricity.battery.lifepo4.charger.LiFePO4ChargerBlockEntity;
...
import org.patryk3211.powergrid.electricity.converter.general.GeneralPowerConditionerBlockEntity;
...
//import org.patryk3211.powergrid.kinetics.generator.speedcontroller.GridSpeedControllerBlockEntity;
...
//import org.patryk3211.powergrid.kinetics.speedcontroller.GridSpeedControllerBlockEntity;
//import org.patryk3211.powergrid.kinetics.speedcontroller.GridSpeedControllerRenderer;
...
public class ModdedBlockEntities {
    ...
    public static final BlockEntityEntry<LiFePO4BatteryBlockEntity> LIFEPO4 =
            REGISTRATE.blockEntity(
                            "lifepo4",
                            LiFePO4BatteryBlockEntity::new
                    )
                    .validBlock(ModdedBlocks.LIFEPO4)
                    .register();

    public static final BlockEntityEntry<CommercialPowerConditionerBlockEntity>
            COMMERCIAL_POWER_CONDITIONER =
            REGISTRATE
                    .blockEntity(
                            "commercial_power_conditioner",
                            CommercialPowerConditionerBlockEntity::new
                    )
                    .validBlock(
                            ModdedBlocks.COMMERCIAL_POWER_CONDITIONER
                    )
                    .register();

    public static final BlockEntityEntry<GeneralPowerConditionerBlockEntity> GENERAL_POWER_CONDITIONER =
            REGISTRATE
                    .blockEntity(
                            "general_power_conditioner",
                            GeneralPowerConditionerBlockEntity::new
                    )
                    .validBlocks(ModdedBlocks.GENERAL_POWER_CONDITIONER)
                    .register();

    /*public static final BlockEntityEntry<LiFePO4ChargerBlockEntity> LIFEPO4_CHARGER =
            REGISTRATE
                    .blockEntity(
                            "lifepo4_charger",
                            LiFePO4ChargerBlockEntity::new
                    )
                    .validBlocks(ModdedBlocks.LIFEPO4_CHARGER)

                    .register();*/

    /*public static final BlockEntityEntry<
            GridSpeedControllerBlockEntity>
            GRID_SPEED_CONTROLLER =
            PowerGrid.REGISTRATE
                    .blockEntity(
                            "grid_speed_controller",
                            GridSpeedControllerBlockEntity::new
                    )
                    /*
                     * CreateのSpeed Controllerと同じFlywheel Visual。
                     * visual() は validBlock() より前に置く。
                     */
                    /*.visual(
                            () -> SingleAxisRotatingVisual::shaft
                    )
                    .validBlock(
                            ModdedBlocks.GRID_SPEED_CONTROLLER
                    )
                    .renderer(
                            () -> GridSpeedControllerRenderer::new
                    )
                    .register();*/


    public static final BlockEntityEntry<SolarBlockEntity> SOLAR_BLOCK_ENTITY =
            REGISTRATE
                    .blockEntity(
                            "solar",
                            SolarBlockEntity::new
                    )
                    .validBlock(
                            ModdedBlocks.SOLAR
                    )
    ...
    public static final BlockEntityEntry<StabilizedPowerSupplyBlockEntity>
            STABILIZED_POWER_SUPPLY =
            REGISTRATE
                    .blockEntity(
                            "stabilized_power_supply",
                            StabilizedPowerSupplyBlockEntity::new
                    )
                    .validBlock(
                            ModdedBlocks.STABILIZED_POWER_SUPPLY
                    )
                    .register();
